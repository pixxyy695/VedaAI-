Here is the task , make very very sure you go the extra mile and implement more intresting things than required and that must work . make sure everything is complete end to end
...
link: https://www.figma.com/design/nB2HMm1BhTpmHcHrmEslGB/VedaAI---Hiring-Assignment?node-id=0-1&p=f
...
Do not directly render LLM response.## **3. Backend System**
...
4. Store result
5. Notify frontend## **4. Output Page (Enhanced)**
...
- Each section should include:
    ...
    - Questions listEach question must display:
...
- Highlight difficulty visually (badges/tags)### **Avoid**
...
- Prompt structuring + parsing required### **1. GitHub Repo**
